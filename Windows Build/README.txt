    ...
    9. Please note that the program only supports 1 course at a time, so if you want to add another course, you will have to
       delete the previous course's info from the config.yaml file and repeat the process above
            -Alternatively, create a new config.yaml and a new Gradescope2Canvas.bat file for each course,
             ...
             corresponding config.yaml file, and then run the Gradescope2Canvas.bat file for each course
...
IV. Grading an Assignment
    ...
    6. Double-Click the Gradescope2Canvas.bat file to run the program
...
V. Processing Resubmissions
   ...
   5. Double-Click the Gradescope2Canvas.bat file to run the program
...
V. Removing an assignment from a Canvas bundles
    ...
    2. Double-Click the Gradescope2Canvas.bat file to run the program
